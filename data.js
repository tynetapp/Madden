/* TyPhone data.js — v1.6.1-public (Aug 14 2026) — REAL ACRES (Ty lifted the data freeze: "nothing has to be frozen"). Urban postage-stamp lots (.02-.15 ac) read as broken in the listings, so every neighborhood floors at 0.18 acres (small ones ×4, capped 0.5); suburban and estate lots stand as they were. Boat Tail still rides the app-side boot overlay — nothing else changed. (prior: v1.6.0-public) */
/* ============ TyNet world data ============
...
D.METROS = {
 "Jets": {city:"New York", hoods:[["Hoboken, NJ",1.45,0.24],["Jersey City (Paulus Hook)",1.2,0.2],["Fort Lee, NJ",0.95,0.5],["Edgewater, NJ",1.05,0.4],["Montclair, NJ",1.1,.25],["Ridgewood, NJ",1.15,.3],["Summit, NJ",1.35,.35],["Short Hills, NJ",2.1,.5],["Alpine, NJ",3.4,1.5],["Saddle River, NJ",2.4,1.8],["Franklin Lakes, NJ",1.8,1.2],["Williamsburg, Brooklyn",1.7,0.18],["Park Slope, Brooklyn",1.9,0.2],["Brooklyn Heights",2.3,0.2],["Tribeca, Manhattan",3.6,0.18],["Upper East Side",2.6,0.18],["Long Island City",1.25,0.18],["Garden City, LI",1.25,.25],["Manhasset, LI",1.9,.4],["Old Westbury, LI",3.0,2.0]]},
 "Bills": {city:"Buffalo", hoods:[["Elmwood Village",0.44,0.4],["North Buffalo",0.4,0.48],["Allentown",0.38,0.32],["Orchard Park",0.52,.5],["East Aurora",0.5,.6],["Hamburg",0.42,.4],["Clarence",0.65,.8],["Williamsville",0.55,.3],["Amherst",0.48,.35],["Kenmore",0.34,0.5],["Grand Island",0.5,.6],["Lancaster",0.42,.4],["West Seneca",0.36,.3],["Snyder",0.52,.3],["Lewiston",0.48,.5],["Niagara-on-the-Lake area",0.55,.5],["Eden",0.38,1.0],["Springville",0.34,1.2],["Ellicottville",0.6,.8],["Waterfront (Marine Drive)",0.5,0.2]]},
 "Dolphins": {city:"Miami", hoods:[["Brickell",1.0,0.18],["Edgewater",0.85,0.18],["Wynwood",0.75,0.2],["Coconut Grove",1.5,.2],["Coral Gables",1.5,.25],["Key Biscayne",2.4,.25],["Miami Beach (South of Fifth)",2.6,0.2],["Sunset Islands",4.5,.35],["Bal Harbour",2.2,0.4],["Aventura",0.9,0.32],["Pinecrest",1.7,.7],["Palmetto Bay",0.95,.5],["Doral",0.8,0.5],["Fort Lauderdale (Victoria Park)",0.85,.2],["Fort Lauderdale (Las Olas Isles)",2.3,.25],["Weston",0.95,.3],["Parkland",1.05,.4],["Boca Raton (Royal Palm)",2.0,.4],["Hollywood Lakes",0.8,.25],["Davie",0.75,.5]]},
 "Patriots": {city:"Boston", hoods:[["Back Bay",2.0,0.18],["Beacon Hill",2.2,0.18],["South End",1.6,0.18],["Seaport",1.5,0.18],["Charlestown",1.2,0.2],["South Boston",1.1,0.2],["Cambridge (Harvard Sq)",1.7,0.4],["Brookline",1.6,.2],["Newton",1.4,.3],["Wellesley",1.8,.5],["Weston, MA",2.4,1.2],["Dover, MA",2.1,2.0],["Needham",1.3,.35],["Milton",1.0,.4],["Hingham",1.2,.5],["Foxborough",0.65,.6],["Franklin",0.6,.5],["Providence (East Side)",0.6,0.5],["Barrington, RI",0.75,.4],["Cape Cod (Osterville)",1.5,.6]]},
 "Ravens": {city:"Baltimore", hoods:[["Federal Hill",0.44,0.18],["Canton",0.46,0.18],["Fells Point",0.5,0.18],["Mount Vernon",0.38,0.18],["Locust Point",0.45,0.18],["Roland Park",0.7,.3],["Guilford",0.75,.3],["Homeland",0.65,.25],["Towson",0.52,.25],["Ruxton",0.9,.8],["Lutherville",0.55,.4],["Owings Mills",0.55,.3],["Pikesville",0.6,.35],["Ellicott City",0.62,.4],["Columbia",0.55,.25],["Annapolis (Downtown)",0.85,0.5],["Severna Park",0.75,.4],["Green Spring Valley",1.4,2.0],["Canton Waterfront",0.7,0.18],["Harbor East",0.8,0.18]]},
 "Bengals": {city:"Cincinnati", hoods:[["Over-the-Rhine",0.44,0.18],["Mount Adams",0.58,0.24],["Hyde Park",0.66,.2],["Oakley",0.5,0.5],["Mount Lookout",0.6,.2],["Columbia Tusculum",0.48,0.48],["East Walnut Hills",0.45,0.5],["Indian Hill",1.5,2.5],["Terrace Park",0.75,.4],["Mariemont",0.6,.25],["Madeira",0.55,.3],["Montgomery",0.62,.4],["Anderson Township",0.48,.5],["Fort Thomas, KY",0.48,.25],["Covington (Mainstrasse)",0.4,0.2],["Newport (East Row)",0.42,0.24],["West Chester",0.5,.35],["Mason",0.52,.35],["Loveland",0.45,.4],["Wyoming, OH",0.58,.3]]},
 "Browns": {city:"Cleveland", hoods:[["Ohio City",0.4,0.2],["Tremont",0.38,0.2],["Detroit-Shoreway",0.34,0.24],["Downtown (Warehouse District)",0.42,0.18],["University Circle",0.4,0.32],["Shaker Heights",0.5,.3],["Cleveland Heights",0.4,.2],["Rocky River",0.52,.25],["Bay Village",0.55,.3],["Westlake",0.58,.35],["Avon Lake",0.52,.4],["Lakewood",0.38,0.48],["Chagrin Falls",0.65,.6],["Hunting Valley",1.6,3.0],["Gates Mills",0.85,1.5],["Pepper Pike",0.75,.9],["Beachwood",0.55,.3],["Strongsville",0.42,.35],["Brecksville",0.5,.5],["Hudson",0.6,.5]]},
 "Steelers": {city:"Pittsburgh", hoods:[["Shadyside",0.52,0.4],["Squirrel Hill",0.5,0.48],["Lawrenceville",0.44,0.2],["South Side Flats",0.4,0.18],["Mount Washington",0.42,0.4],["Highland Park",0.42,0.5],["Point Breeze",0.48,.2],["Regent Square",0.42,0.48],["Sewickley",0.8,.5],["Sewickley Heights",1.6,2.5],["Fox Chapel",1.1,1.2],["Mt. Lebanon",0.5,.2],["Upper St. Clair",0.6,.4],["Peters Township",0.55,.5],["Cranberry Township",0.5,.35],["Wexford",0.55,.5],["Oakmont",0.45,.25],["Aspinwall",0.42,0.4],["North Shore (condos)",0.5,0.18],["Downtown (Cultural District)",0.45,0.18]]},
 "Texans": {city:"Houston", hoods:[["The Heights",0.6,0.48],["Montrose",0.62,0.4],["Midtown",0.5,0.2],["EaDo",0.45,0.24],["River Oaks",2.5,.5],["Memorial (Villages)",1.2,.4],["Tanglewood",1.3,.4],["West University Place",1.1,.2],["Bellaire",0.85,.25],["Museum District",0.7,0.4],["Garden Oaks",0.55,.2],["Oak Forest",0.5,.18],["Spring Branch",0.55,.25],["Katy (Cinco Ranch)",0.48,.2],["Sugar Land",0.5,.25],["The Woodlands",0.55,.3],["Pearland",0.42,.2],["Cypress (Towne Lake)",0.5,.25],["Kingwood",0.42,.3],["Friendswood",0.45,.3]]},
 "Colts": {city:"Indianapolis", hoods:[["Broad Ripple",0.42,0.5],["Meridian-Kessler",0.52,.25],["Butler-Tarkington",0.44,.2],["Fountain Square",0.36,0.32],["Mass Ave (Downtown)",0.42,0.18],["Herron-Morton",0.48,0.4],["Irvington",0.32,0.5],["Carmel",0.65,.3],["Carmel (Village of WestClay)",0.75,.35],["Zionsville",0.72,.5],["Fishers",0.52,.3],["Noblesville",0.45,.35],["Westfield",0.5,.3],["Geist",0.75,.5],["Meridian Hills",0.8,.8],["Williams Creek",0.9,1.0],["Greenwood",0.38,.3],["Avon",0.4,.3],["Brownsburg",0.38,.3],["McCordsville",0.42,.35]]},
 "Jaguars": {city:"Jacksonville", hoods:[["Riverside",0.44,0.5],["Avondale",0.48,.2],["San Marco",0.52,.2],["Springfield",0.34,0.48],["Murray Hill",0.32,0.5],["Ortega",0.7,.4],["San Jose",0.5,.3],["Mandarin",0.52,.4],["Jacksonville Beach",0.7,0.5],["Neptune Beach",0.75,.18],["Atlantic Beach",0.8,.2],["Ponte Vedra Beach",1.3,.4],["Nocatee",0.6,.2],["Julington Creek",0.5,.3],["Fleming Island",0.48,.3],["Amelia Island",0.9,.3],["St. Johns (Durbin)",0.52,.25],["Queens Harbour",0.85,.4],["Epping Forest",1.2,.6],["Downtown (Brooklyn)",0.4,0.18]]},
 "Titans": {city:"Nashville", hoods:[["The Gulch",0.8,0.18],["Germantown",0.7,0.2],["East Nashville (Lockeland Springs)",0.6,0.5],["12 South",0.85,0.5],["Green Hills",1.0,.3],["Belle Meade",2.2,1.0],["Forest Hills",1.5,1.2],["Oak Hill",1.2,1.0],["Sylvan Park",0.62,0.5],["The Nations",0.5,0.4],["Wedgewood-Houston",0.55,0.32],["Brentwood",1.2,.8],["Franklin (Westhaven)",0.95,.25],["Franklin (Downtown)",0.9,.3],["Thompson's Station",0.65,.6],["Nolensville",0.6,.4],["Mt. Juliet",0.5,.35],["Hendersonville",0.5,.4],["College Grove (The Grove)",1.4,1.0],["Leiper's Fork",1.3,3.0]]},
 "Broncos": {city:"Denver", hoods:[["LoDo",0.75,0.18],["RiNo",0.6,0.18],["Washington Park",0.95,0.48],["Cherry Creek",1.35,0.4],["Country Club",1.6,.25],["Highlands (LoHi)",0.85,0.32],["Berkeley",0.65,0.48],["Congress Park",0.7,0.48],["Observatory Park",1.0,.2],["Hilltop",1.2,.25],["Cherry Hills Village",2.6,1.0],["Greenwood Village",1.2,.6],["Castle Pines",0.95,.4],["Lone Tree",0.75,.25],["Golden",0.7,.3],["Boulder (Chautauqua)",1.6,.3],["Evergreen",0.85,1.5],["Morrison",0.7,1.0],["Littleton (Ken Caryl)",0.6,.3],["Parker",0.6,.3]]},
 "Chiefs": {city:"Kansas City", hoods:[["Country Club Plaza",0.58,0.32],["Brookside",0.5,0.5],["Waldo",0.38,0.5],["River Market",0.42,0.18],["Crossroads",0.45,0.18],["Westport",0.4,0.4],["Hyde Park KC",0.42,0.5],["Mission Hills, KS",1.6,.5],["Prairie Village",0.55,.25],["Leawood",0.75,.35],["Overland Park (Hallbrook)",0.9,.4],["Fairway",0.5,.25],["Lenexa",0.48,.3],["Olathe",0.42,.3],["Lee's Summit",0.45,.3],["Parkville",0.5,.4],["Liberty",0.4,.3],["Loch Lloyd",1.1,.8],["Weatherby Lake",0.6,.4],["Briarcliff",0.55,.25]]},
 "Raiders": {city:"Las Vegas", hoods:[["Summerlin (The Ridges)",2.0,.4],["Summerlin (Red Rock CC)",1.2,.3],["Summerlin (Downtown)",0.72,0.5],["The Summit Club",4.5,.8],["MacDonald Highlands",2.2,.5],["Anthem Country Club",0.9,.3],["Seven Hills",0.85,.3],["Green Valley Ranch",0.6,.2],["Lake Las Vegas",0.9,.3],["Southern Highlands",0.9,.35],["Spanish Trail",0.75,.3],["Queensridge",1.1,.35],["The Lakes",0.65,.25],["Centennial Hills",0.5,.25],["Skye Canyon",0.55,.2],["Inspirada",0.55,.18],["Downtown (Arts District)",0.45,0.2],["Boulder City",0.5,.3],["Mount Charleston",0.6,.8],["Henderson (Ascaya)",3.0,.6]]},
 "Chargers": {city:"Los Angeles", hoods:[["Manhattan Beach",2.8,0.4],["Hermosa Beach",2.3,0.32],["Redondo Beach",1.5,0.4],["Playa Vista",1.4,0.24],["Venice",1.8,0.32],["Santa Monica",2.2,0.4],["Pacific Palisades",3.4,.25],["Brentwood, LA",3.0,.3],["Beverly Hills (Flats)",4.5,.4],["Bel Air",4.8,.8],["Hollywood Hills",2.0,.25],["Silver Lake",1.3,0.48],["Los Feliz",1.7,.2],["Studio City",1.5,.2],["Encino",1.6,.35],["Calabasas (The Oaks)",2.4,.5],["Hidden Hills",3.5,1.2],["Pasadena (Madison Heights)",1.4,.25],["San Marino",2.4,.4],["Palos Verdes Estates",2.2,.4]]},
 "Rams": {city:"Los Angeles", hoods:"Chargers"},
 "Giants": {city:"New York", hoods:"Jets"},
 "Cowboys": {city:"Dallas", hoods:[["Uptown",0.8,0.18],["Highland Park",2.6,.3],["University Park",1.9,.25],["Preston Hollow",1.8,.5],["Lakewood",0.75,.25],["M Streets",0.65,0.5],["Bishop Arts",0.5,0.4],["Deep Ellum",0.52,0.18],["Knox-Henderson",0.75,0.32],["Devonshire",0.9,.25],["Frisco (Starwood)",0.85,.25],["Frisco (Newman Village)",0.95,.3],["Plano (Willow Bend)",0.75,.3],["Southlake",1.2,.5],["Westlake (Vaquero)",2.6,.8],["Colleyville",0.9,.5],["Prosper",0.7,.35],["Celina (Light Farms)",0.6,.25],["Flower Mound",0.62,.3],["McKinney (Stonebridge)",0.55,.25]]},
 "Eagles": {city:"Philadelphia", hoods:[["Rittenhouse Square",1.0,0.18],["Society Hill",0.95,0.18],["Old City",0.65,0.18],["Fishtown",0.5,0.18],["Northern Liberties",0.6,0.18],["Graduate Hospital",0.65,0.18],["Fairmount",0.55,0.18],["Queen Village",0.7,0.18],["Chestnut Hill",0.75,.25],["Mt. Airy",0.45,0.5],["Haddonfield, NJ",0.7,.25],["Moorestown, NJ",0.65,.4],["Cherry Hill, NJ",0.5,.3],["Ardmore (Main Line)",0.65,.2],["Bryn Mawr",0.9,.4],["Villanova",1.4,.8],["Gladwyne",1.7,1.0],["Wayne",0.85,.4],["Newtown Square",0.75,.5],["Media",0.55,.25]]},
 "Commanders": {city:"Washington", hoods:[["Georgetown",1.6,0.2],["Logan Circle",0.95,0.18],["Capitol Hill",0.9,0.18],["Navy Yard",0.8,0.18],["Shaw",0.85,0.18],["Dupont Circle",0.95,0.18],["Kalorama",1.9,0.4],["Spring Valley",1.7,.3],["Chevy Chase, DC",1.3,0.5],["Bethesda, MD",1.2,.2],["Potomac, MD",1.5,.9],["Chevy Chase Village, MD",1.8,.25],["Arlington (Clarendon)",1.0,0.32],["Arlington (Country Club Hills)",1.6,.3],["McLean, VA",1.7,.5],["Great Falls, VA",1.6,1.5],["Alexandria (Old Town)",0.95,0.2],["Vienna, VA",1.0,.3],["Falls Church City",0.95,.2],["Ashburn (One Loudoun)",0.7,0.5]]},
 "Bears": {city:"Chicago", hoods:[["Lincoln Park",1.0,0.2],["Gold Coast",1.5,0.18],["West Loop",0.9,0.18],["River North",0.75,0.18],["Wicker Park",0.75,0.2],["Bucktown",0.7,0.2],["Lakeview",0.65,0.18],["Logan Square",0.55,0.2],["Streeterville",0.7,0.18],["Old Town",0.85,0.18],["Hyde Park (Kenwood)",0.6,0.5],["Evanston",0.65,0.5],["Wilmette",0.9,.25],["Winnetka",1.6,.5],["Kenilworth",2.0,.5],["Glencoe",1.4,.4],["Highland Park, IL",0.9,.4],["Lake Forest",1.2,.9],["Hinsdale",1.3,.4],["Oak Brook",1.0,.7]]},
 "Lions": {city:"Detroit", hoods:[["Corktown",0.36,0.2],["Midtown Detroit",0.38,0.18],["Brush Park",0.45,0.18],["Indian Village",0.4,.2],["Boston-Edison",0.35,.2],["Palmer Woods",0.5,.3],["Grosse Pointe",0.6,.25],["Grosse Pointe Farms",0.75,.3],["Grosse Pointe Shores",0.9,.4],["Royal Oak",0.45,0.5],["Ferndale",0.38,0.48],["Birmingham, MI",0.9,.25],["Bloomfield Hills",1.3,.8],["West Bloomfield",0.6,.4],["Franklin, MI",0.9,.8],["Northville",0.6,.3],["Plymouth",0.5,.25],["Rochester Hills",0.5,.3],["Troy",0.48,.25],["Ann Arbor (Burns Park)",0.7,.2]]},
 "Packers": {city:"Green Bay", hoods:[["Astor Park",0.3,0.5],["Olde Main Street",0.26,0.48],["De Pere (East)",0.4,.25],["De Pere (West)",0.38,.25],["Allouez",0.34,.25],["Ashwaubenon",0.32,.25],["Howard",0.34,.3],["Suamico",0.44,.5],["Bellevue",0.34,.3],["Ledgeview",0.5,.5],["Hobart",0.45,.5],["Lawrence",0.4,.4],["Green Bay (Bay Beach area)",0.3,.2],["Oneida",0.28,.5],["Wrightstown",0.32,.4],["Appleton (North)",0.4,.3],["Neenah (Island)",0.45,.3],["Door County (Egg Harbor)",0.6,.8],["Door County (Fish Creek)",0.65,.8],["Shorewood Hills (Madison)",0.75,.3]]},
 "Vikings": {city:"Minneapolis", hoods:[["North Loop",0.65,0.18],["Mill District",0.6,0.18],["Uptown",0.52,0.32],["Linden Hills",0.75,0.5],["Fulton",0.65,0.5],["Kenwood",1.0,.25],["Lowry Hill",0.85,.2],["Southwest (Armatage)",0.5,0.5],["Edina (Country Club)",1.1,.3],["Edina (Indian Hills)",1.2,.6],["Wayzata",1.4,.4],["Orono",1.3,1.0],["Deephaven",1.1,.6],["Minnetonka",0.65,.4],["Plymouth, MN",0.6,.3],["Eden Prairie",0.62,.3],["St. Paul (Crocus Hill)",0.6,0.5],["St. Paul (Highland Park)",0.5,0.5],["North Oaks",0.95,1.2],["Maple Grove",0.5,.25]]},
 "Falcons": {city:"Atlanta", hoods:[["Buckhead (Tuxedo Park)",2.2,.9],["Buckhead (Garden Hills)",1.0,.3],["Midtown ATL",0.7,0.18],["Inman Park",0.75,0.5],["Old Fourth Ward",0.65,0.32],["Virginia-Highland",0.85,.2],["Morningside",0.95,.25],["Ansley Park",1.3,.3],["Candler Park",0.6,0.5],["Grant Park",0.55,0.48],["Decatur",0.6,.2],["Brookhaven (Historic)",1.0,.3],["Sandy Springs",0.8,.4],["Dunwoody",0.65,.35],["Vinings",0.75,.3],["Smyrna",0.5,.2],["Alpharetta (Avalon)",0.75,.25],["Milton",0.95,1.0],["Johns Creek",0.6,.35],["East Cobb",0.6,.35]]},
 "Panthers": {city:"Charlotte", hoods:[["South End",0.6,0.2],["Dilworth",0.7,0.5],["Myers Park",1.2,.35],["Eastover",1.5,.5],["Elizabeth",0.65,0.5],["Plaza Midwood",0.55,0.48],["NoDa",0.5,0.4],["Fourth Ward",0.55,0.18],["Wesley Heights",0.5,0.32],["SouthPark",0.85,.3],["Foxcroft",1.1,.4],["Cotswold",0.6,.25],["Ballantyne",0.65,.25],["Waxhaw (Marvin)",0.85,.7],["Weddington",0.9,.9],["Davidson",0.7,.3],["Cornelius (The Peninsula)",0.9,.35],["Lake Norman (Mooresville)",0.75,.4],["Fort Mill, SC",0.55,.3],["Matthews",0.5,.25]]},
 "Saints": {city:"New Orleans", hoods:[["Garden District",0.8,0.5],["Uptown",0.65,0.48],["Audubon",0.85,.2],["French Quarter",0.7,0.18],["Marigny",0.48,0.2],["Bywater",0.42,0.24],["Lakeview",0.55,0.5],["Lake Vista",0.75,.25],["Mid-City",0.4,0.32],["Broadmoor",0.38,0.4],["English Turn",0.6,.4],["Old Metairie",0.7,.25],["Metairie (Lakefront)",0.5,.2],["Mandeville",0.5,.4],["Covington",0.48,.5],["Madisonville",0.45,.4],["Slidell (Oak Harbor)",0.4,.3],["Kenner (Chateau Estates)",0.38,.25],["Gretna (Timberlane)",0.35,.3],["Belle Chasse",0.38,.35]]},
 "Buccaneers": {city:"Tampa", hoods:[["Hyde Park",0.8,0.5],["Davis Islands",1.5,.2],["Harbour Island",1.2,0.4],["Bayshore Beautiful",0.9,.2],["Palma Ceia",0.85,.2],["Beach Park",1.1,.3],["Westshore",0.7,.2],["Seminole Heights",0.45,0.5],["Channelside",0.6,0.18],["Water Street (condos)",0.9,0.18],["Westchase",0.55,.2],["Carrollwood",0.5,.25],["Lutz",0.5,.4],["Odessa (Keystone)",0.8,1.0],["Wesley Chapel",0.45,.2],["Apollo Beach",0.55,.2],["St. Pete (Old Northeast)",0.65,0.5],["St. Pete (Snell Isle)",1.1,.25],["Clearwater Beach",0.9,0.4],["Belleair",0.9,.4]]},
 "Cardinals": {city:"Phoenix", hoods:[["Arcadia",0.95,.35],["Biltmore",0.85,.3],["Paradise Valley",2.4,1.0],["North Scottsdale (Silverleaf)",2.8,.8],["Scottsdale (Old Town)",0.75,0.4],["Scottsdale (McCormick Ranch)",0.8,.25],["Scottsdale (DC Ranch)",1.5,.4],["Desert Mountain",1.6,.8],["Troon",1.0,.6],["Cave Creek",0.7,1.0],["Fountain Hills",0.7,.4],["Central Phoenix (Willo)",0.55,0.5],["Ahwatukee",0.55,.25],["Chandler (Ocotillo)",0.6,.25],["Gilbert (Agritopia)",0.55,.2],["Mesa (Las Sendas)",0.6,.3],["Queen Creek",0.5,.3],["Tempe (near ASU)",0.5,0.5],["Peoria (Vistancia)",0.55,.25],["Litchfield Park",0.5,.3]]},
 "49ers": {city:"San Francisco Bay", hoods:[["Marina District",2.0,0.18],["Pacific Heights",3.2,0.2],["Noe Valley",1.9,0.2],["Russian Hill",2.2,0.18],["Mission District",1.4,0.18],["Cole Valley",1.7,0.2],["Palo Alto",2.9,.2],["Menlo Park",2.6,.25],["Atherton",6.5,1.0],["Hillsborough",4.2,.7],["Burlingame",2.2,.2],["San Mateo",1.6,0.5],["Los Altos",3.2,.3],["Los Gatos",2.4,.3],["Saratoga",2.8,.5],["Willow Glen (San Jose)",1.5,.2],["Santa Clara (Rivermark)",1.4,0.32],["Sunnyvale",1.7,0.5],["Woodside",4.5,1.5],["Mill Valley",1.9,.3]]},
 "Seahawks": {city:"Seattle", hoods:[["Capitol Hill",0.9,0.24],["Queen Anne",1.1,0.4],["Ballard",0.85,0.32],["Fremont",0.85,0.32],["Wallingford",0.9,0.4],["Green Lake",0.9,0.4],["Madison Park",1.5,0.5],["Laurelhurst",1.6,.2],["Magnolia",1.1,0.5],["West Seattle (Alki)",0.85,0.48],["Bellevue (West)",1.8,.25],["Bellevue (Bridle Trails)",1.6,.5],["Medina",4.5,.6],["Clyde Hill",3.2,.4],["Kirkland (Juanita)",1.2,.2],["Mercer Island",1.9,.3],["Redmond (Education Hill)",1.1,.18],["Sammamish",1.2,.3],["Issaquah Highlands",0.95,0.5],["Woodinville",1.0,.6]]}
};
